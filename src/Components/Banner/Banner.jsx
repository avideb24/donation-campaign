        ...
        <div className="banner">
            <div className="py-40 relative">
                ...
                <div className="max-w-7xl mx-auto relative z-20 text-center">
                    <h1 className="text-black text-5xl font-bold mb-10">I Grow By Helping People In Need</h1>
                    <div>
                        <input type="text" placeholder="Search Category..." className="input input-bordered w-full max-w-xs rounded-tr-none rounded-br-none" />
